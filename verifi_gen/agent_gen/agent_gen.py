...
def uvm_file_gen(filename, **kwargs):
    ...
    fd = open(agent_dir + os.sep + filename.replace('template', agent_name), 'w',newline='')
...
uvm_file_gen('template_seq_item.svh', agent_name=agent_name, itf=itf, seq_name=seq_name)
